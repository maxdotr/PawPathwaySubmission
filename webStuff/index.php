...
<head>
    ...
    <title>PawPawthway, Find Lost Dogs Through Twitter.</title>
    <meta name="description" content="PawPathway scans Twitter for mentions of lost dogs and adds them to our registry. We want to help owners reconnect with their furry friends. Check our database to see if your dog is in there." />
...
<body>
    ...
    <div class="container container-md container-sm h-100" id="main">
        ...
        <section id="heading" class="text-center">
            <h1><b>PawPathway</b></h1>
            <h5>Find your lost dog through the power of Twitter...</h5>
        </section> <!-- end heading -->
        
        <section id="logo" class="w-50 mx-auto d-block">
            <a href="https://twitter.com/PawPathway">
                <img src="foxwav.jpg" class="img-fluid rounded-circle mx-auto pb-4 d-block">
            </a>
        </section><!-- end logo -->
        ...
        <section id="feed">
            <div class="center-all">
                ...
                <a class="twitter-timeline" data-width="700" data-height="700" href="https://twitter.com/PawPathway?ref_src=twsrc%5Etfw">Tweets by PawPathway</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
        </section>

        <section id="table" class="center-all">
            <h1>Alternatively, Check Our Database:</h1>
            <table class="table table-responsive center-all pl-4">
    ...
    <footer class="navbar">
        <div class="container container-fluid footer mb-0">
